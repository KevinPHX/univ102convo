...
st.write("In UNIV102, we often discuss ways in which we communicate climate change and what are the effective ways of discussing its impacts to a potentially unreceptive audience. For my conversation starter, I decided to look at how people have discussed climate change on the largest global forum: Twitter (now X). This project is a series of visualizations that tell the story of climate communication on the internet from a bird's eye view via an exploration in to the Climate Change Twitter Dataset from Effrosynidis et al.")
